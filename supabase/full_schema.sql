...
-- 11. SECURE SERVER-SIDE ATTENDANCE RECORDING RPC (Blocks client field tampering)
...
-- 12. AUTOMATIC COMPANY REGISTRATION TRIGGER
...
-- 13. SCHEMA CONSTRAINTS (Validate input boundaries)
DO $$ BEGIN
